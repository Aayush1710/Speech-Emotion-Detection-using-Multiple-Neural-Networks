...
%%Training Network (spread factor)
Grnn_net = newgrnn(Input_train,Target_train,0.05); % vary spread factor

%%Testing
data=zeros(501,5*10);%data matrix of 50*50 for training
for i=1:10 %converting 5 voice samples in array in 1 iteration(happy,crying,excited,angry,neutral)
    no=num2str(i); 
